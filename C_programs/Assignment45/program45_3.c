...
//  Description   : Returns the position of last occurrence of a given number
//                  in the linked list
//  Input         : PNODE, int
...
int main()
{
    ...
    printf("Enter the element to search last occurrence :\n");
    scanf("%d", &iNo);

    iPos = LastOccur(head, iNo);
...
//  Enter the element to search last occurrence :
//  111
//  Last occurrence of 111 is at position 8
