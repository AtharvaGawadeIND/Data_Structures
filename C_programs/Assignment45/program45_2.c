...
//  Description   : Returns the position of first occurrence of a given number
//                  in the linked list
//  Input         : PNODE, int
...
int main()
{
    ...
    printf("Enter the element to search first occurrence :\n");
    scanf("%d", &iNo);

    iPos = FirstOccur(head, iNo);
...
//  Enter the element to search first occurrence :
//  21
//  First occurrence of 21 is at position 4
//
/////////////////////////////////////////////////////////////////////////////////////////////////
