...
//  Description   : Replaces all negative values in the linked list with
...
int main()
{
    ...
    MakeAbsolute(&head);
    printf("After replacing negative numbers with absolute values:\n");
    Display(head);
...
//  After replacing negative numbers with absolute values:
//  | 2 | -> | 20 | -> | 11 | -> | 21 | -> | 51 | -> | 101 | -> | 111 | -> | 111 | -> NULL
//
/////////////////////////////////////////////////////////////////////////////////////////////////