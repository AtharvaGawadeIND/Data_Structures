...
//  Description   : Increments data value of each node in the linked list by 1
//  Input         : PPNODE
...
int main()
{
    ...
    printf("Linked list after incrementing all elements:\n");
    Display(head);
...
//  Output:
//  ./myexe
//  | -2 | -> | -20 | -> | 2 | -> | 20 | -> | 11 | -> | 21 | -> | 51 | -> | 101 | ->
//   ->| 111 | -> | 111 | -> | -111 | -> NULL
//  Linked list after incrementing all elements:
//  | -1 | -> | -19 | -> | 3 | -> | 21 | -> | 12 | -> | 22 | -> | 52 | -> | 102 | -> 
//    ->| 112 | -> | 112 | -> | -110 | -> NULL
//
/////////////////////////////////////////////////////////////////////////////////////////////////
