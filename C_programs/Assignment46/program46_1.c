...
//  Description   : Displays elements from the linked list that are greater than given number X
//  Input         : PNODE, int
//  Output        : Prints elements greater than X
//  Return Type   : void
//  Author        : Atharva Vinod Gawade
//  Date          : 1/1/2026
//
