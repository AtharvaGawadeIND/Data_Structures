...
//  Description   : Replaces all even values in the linked list with zero
//  Input         : PPNODE
...
int main()
{
    ...
    ReplaceEven(&head);
    printf("Linked list after replacing even numbers:\n");
    Display(head);
...
//  Linked list after replacing even numbers:
//  | 0 | -> | 0 | -> | 11 | -> | 21 | -> | 51 | -> | 101 | -> | 111 | -> | 111 | -> NULL
//
/////////////////////////////////////////////////////////////////////////////////////////////////