...
//  Description   : Multiplies data value of each node in the linked list by 2
//  Input         : PPNODE
//  Output        : Modified linked list (each value multiplied by 2)
//  Return Type   : void
//  Author        : Atharva Vinod Gawade
//  Date          : 1/1/2026
//
...
int main()
{
    ...
    MultiplyByTwo(&head);
    printf("Linked list after multiplying all elements by 2:\n");
    Display(head);
...
//  Linked list after multiplying all elements by 2:
//  | 4 | -> | 40 | -> | 22 | -> | 42 | -> | 102 | -> | 202 | -> | 222 | -> | 222 | -> NULL
//
/////////////////////////////////////////////////////////////////////////////////////////////////