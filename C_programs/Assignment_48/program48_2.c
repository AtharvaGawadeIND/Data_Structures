...
//  Description   : Replaces all odd values in the linked list with 1
//  Input         : PPNODE
...
int main()
{
    ...
    ReplaceOdd(&head);
    printf("Linked list after replacing odd numbers:\n");
    Display(head);
...
//  Linked list after replacing odd numbers:
//  | 2 | -> | 20 | -> | 1 | -> | 1 | -> | 1 | -> | 1 | -> | 1 | -> | 1 | -> NULL
//
/////////////////////////////////////////////////////////////////////////////////////////////////